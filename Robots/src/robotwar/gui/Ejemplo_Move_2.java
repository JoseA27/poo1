...
public class Ejemplo_Move_2 implements KeyListener {
		...
		public void Simular() {
			...
			try {
				myPicture = ImageIO.read(new File(rutaImagenes + "dalek.png"));
				myPicture2 = ImageIO.read(new File(rutaImagenes + "Fuego.png"));
		...
		void Background(JPanel panel) {
			...
			try {
				BufferedImage myPicture = null;
				myPicture = ImageIO.read(new File(rutaImagenes + "Fondo.jpg"));
				JLabel picLabel = new JLabel(new ImageIcon(myPicture));
		...
		void mostrarTrampas(JPanel panel) {
			...
			try {
				BufferedImage myPicture = null;
				myPicture = ImageIO.read(new File(rutaImagenes + "sierra.png"));
				JLabel picLabel = new JLabel(new ImageIcon(myPicture));
				panel.add(picLabel);
				Dimension size = picLabel.getPreferredSize();
		        ...
		        BufferedImage myPicture2 = null;
				myPicture2 = ImageIO.read(new File(rutaImagenes + "sierra.png"));
				JLabel picLabel2 = new JLabel(new ImageIcon(myPicture2));
				panel.add(picLabel2);
				...
				myPicture3 = ImageIO.read(new File(rutaImagenes + "sierra.png"));
